...
func (a *OrmManager) createDatabase() error {
	...
	_, err = engine.Exec("CREATE DATABASE IF NOT EXISTS casbin_metadata default charset utf8 COLLATE utf8_general_ci")
	return err
}
...
func (a *OrmManager) open() {
	...
	engine, err := xorm.NewEngine(a.driverName, a.dataSourceName+"casbin_metadata")
	if err != nil {
		panic(err)
	}
